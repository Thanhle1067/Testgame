...
// Back-compat: /api/gift (may include ?type=rescue or sec can be negative)
...
// NEW: always ADD (no need to pass type)
...
// NEW: always RESCUE (subtract). If sec is provided and positive, client will subtract it.
